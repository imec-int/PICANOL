...
{   
    ...
    public void Start()
    {
		...
		Debug.Log("debugU: TangoCamera = "+m_camera.name.ToString());
		m_camera.tag="TangoCam";
    ...
    {
		Debug.Log ("debugU: Tango disconnected");
    }
...
//			Debug.Log ("debugU: nieuwe camera texture");
        }
    }
    ...
    {
		Debug.Log ("debugU: Camera update for intrinsics");
                                     ...
                                     OrientationManager.Rotation colorCameraRotation)
    {
        ...
        else
        {
			...
			Debug.LogError("debugU: AR Camera intrinsic is not valid.");
        }
    }
