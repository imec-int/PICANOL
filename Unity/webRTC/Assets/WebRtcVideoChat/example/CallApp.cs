...
public class CallApp : MonoBehaviour
{
	...
	private UnityVideoCapturer UVidCap;
	...
	protected virtual void Start ()
	{
		...
		UVidCap = new UnityVideoCapturer ("UVidCap");
		...
		mMediaConfig.IdealWidth = 640;//320;
		mMediaConfig.IdealHeight = 480;//240;
...
//
//			UVidCap.mTexture.Stop ();
//			UVidCap.mTexture.deviceName = (UVidCap.mTexture.deviceName == UVidCap.devices [0].name) ? UVidCap.devices [1].name : UVidCap.devices [0].name;
//			UVidCap.mTexture.Play ();
//
//		}
